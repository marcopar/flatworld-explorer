...
public class NLTL7DataProvider extends NLTL7Provider implements Runnable {

    final static String NAME = "NLTL7StaticFilesystemProvider";
    String path;

    public NLTL7DataProvider(String path) {
        this.path = path;
